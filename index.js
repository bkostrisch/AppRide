...
allRides.forEach( async ([id, value]) => {
    ...
    itemElement.className = " d-flex p-2 align-items-center justify-content-between shadow-sm gap-3";
    ...
    const map = L.map(mapID, { zoomControl:false, dragging: false, scrollWheelZoom: false, touchZoom: false });
